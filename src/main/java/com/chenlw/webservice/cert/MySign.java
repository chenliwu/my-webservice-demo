...
public class MySign {
    ...
    public static void main(String[] args) throws Exception {
        ...
        boolean isRight = MySign.verifySignString(sign, base64);
        System.out.println("\n验签结果：" + isRight);
    }
    ...
    public static String signToBase64(String data)
            throws Exception {
        byte[] byteData = data.getBytes(StandardCharsets.UTF_8.name());
     ...
     * @param sign 数据签名[BASE64]
     */
    public static boolean verifySignString(String data, String sign)
            throws Exception {
        byte[] byteData = data.getBytes(StandardCharsets.UTF_8.name());
